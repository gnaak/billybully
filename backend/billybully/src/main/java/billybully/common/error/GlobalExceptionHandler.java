...
import billybully.common.LoggingUtils;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    @ExceptionHandler(BillyBullyException.class)
    public ResponseEntity<ErrorResponse> handleBillyBullyException(BillyBullyException exception) {
