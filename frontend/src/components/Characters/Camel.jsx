...
const Camel = ({ diceScore, location, opacity }) => {
  const camelPath = "/public/characters/Camel.gltf";
  const camel = useLoader(GLTFLoader, camelPath);
